...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-BGC2ohq8.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-LuZ6gtce.js");
		return {
			get "ErrorBoundary"() {
	...
	"d9f0b3c90147": async () => {
		const m = await import("./assets/SmartAttApp-DTRR50Fh.js");
		return { get "default"() {
			return m["default"];
		} };
	}
...
//#endregion
export { ReadonlyURLSearchParams as a, __commonJSMin as c, app_ssr_entry_default as default, handleSsr, useRouter as i, __toESM as l, getLayoutSegmentContext as n, require_react as o, usePathname as r, stripBasePath as s, require_jsx_runtime as t };
