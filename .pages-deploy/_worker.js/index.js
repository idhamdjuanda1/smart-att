globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/typeof-B5P0Path.js","assets/SmartAttApp-BFaQy1lH.js","assets/index.es-6SEIizv-.js","assets/purify.es-gwrf7E0k.js","assets/html2canvas-B-3GK8TX.js","assets/jspdf.es.min-DdXi1FgN.js","assets/layout-segment-context-CJBRVCIp.js"];
...
function getDraftSecret() {
	return "94e48bfa-0e48-47b4-b977-6df543f96c6b";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "229cbbb0-ceb2-43cd-822d-1c9082b10319";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "229cbbb0-ceb2-43cd-822d-1c9082b10319") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "229cbbb0-ceb2-43cd-822d-1c9082b10319",
		rootBoundaryId
	});
}
/**
...
//#endregion
//#region app/components/SmartAttApp.tsx
var SmartAttApp_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "d9f0b3c90147", "default");
//#endregion
//#region app/[[...slug]]/page.tsx
var page_exports = /* @__PURE__ */ __exportAll({ default: () => CatchAllPage });
function CatchAllPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SmartAttApp_default, {});
}
...
var FIREBASE_API_KEY = "AIzaSyD2FV_FSGtqD-u7BQtxLpRfSZZqOTXJqcQ";
async function authenticatedUid(request) {
	...
	return (await response.json()).users?.[0]?.localId ?? null;
}
...
async function handleStorage(request, env, url) {
	...
	if (request.method === "POST" && url.pathname === "/api/storage/photos") {
		...
		if (![
			...
			"image/png",
			"image/webp"
		].includes(file.type)) return json({ error: "Format foto tidak didukung" }, 415);
...
var worker_entry_default = { async fetch(request, env, ctx) {
	...
	if (url.pathname === "/_vinext/image") return handleImageOptimization(request, {
